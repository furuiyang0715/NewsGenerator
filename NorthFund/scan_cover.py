...
class NorthFund(NewsBase):
    def __init__(self):
        ...
        self.target_table = 'news_covergenerate_flownorth'
    ...
    # def cover_little_interval(self, _map):
    #     pass
    ...
    def start(self, _now):
        ...
        # self.cover_little_interval(positive)
        # self.cover_little_interval(negative)
